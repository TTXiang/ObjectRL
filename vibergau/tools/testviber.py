...
if __name__ == '__main__':
    ...
    parser.add_argument('--cls_weights_path', type=str, default=r"vibergau/weights/cls3.pth", help='weights path')
    parser.add_argument('--device', default=0, help='device id (i.e. 0 or 0,1 or cpu)')
    # 文件保存地址
    parser.add_argument('--output-pics', default=r'outputs/vibeoutputs', help='path where to save')
    ...
    # cv2.namedWindow('Row Images', cv2.WINDOW_NORMAL)
    # cv2.resizeWindow('Row Images', 480, 340)
    # cv2.namedWindow('Viber Images', cv2.WINDOW_NORMAL)
    # cv2.resizeWindow('Viber Images', 480, 340)
    # cv2.namedWindow('Cls Images', cv2.WINDOW_NORMAL)
    # cv2.resizeWindow('Cls Images', 480, 340)
    inferviber(args)
